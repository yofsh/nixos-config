            ...
            bookmarks = [
              {
                name = "Plex";
                url =
                  "http://srv-prod-nas.home.USER_NAMEkiss.net:32400/web/index.html#!";
              }
              {
                name = "Proxmox";
                url =
                  "https://srv-prod-proxmox.home.USER_NAMEkiss.net:8006/#v1:0:18:4:::::::";
              }
              {
                name = "Home Assistant";
                url =
                  "http://srv-prod-hac.home.USER_NAMEkiss.net:8123/lovelace/HPCA";
              }
              {
                name = "Router";
                url =
                  "https://router.home.USER_NAMEkiss.net/network/default/dashboard";
              }
              {
                name = "Docker";
              ...
              }
              {
                name = "NAS";
                url =
                  "https://srv-prod-nas.home.USER_NAMEkiss.net/ui/dashboard";
              }
              {
                name = "";
                url = "";
            ...
            bookmarks = [
              {
                name = "Dominion";
                url =
                  "https://docs.google.com/spreadsheets/d/1nNXydoOHAUUW18FTjk4O5QZnyipzyVkQ5rm2V-5bUaE/edit?pli=1";
              }
              {
                name = "Pathbuilder2E";
                # toolbar = true;
              ...
              }
              {
                name = "Mark's Books";
                url =
                  "https://drive.google.com/drive/folders/1uce9hs9MrRcIZebNvdQbvYLi-6vbkV9m";
              }
            ];
          }
          {
